...
class GetRecommendedRepository implements IGetRecommendedRepository {
  final IGetRecommendedDatasource datasource;

  const GetRecommendedRepository({required this.datasource});

  @override
  Future<Either<Failure, List<CompanyItemEntity>>> getRecommended() async {
    try {
      ListCompanyItemsModel result = await datasource.getRecommended();
