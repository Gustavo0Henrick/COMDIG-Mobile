...
main() {
  ...
  late GetEventDatasource datasource;

  setUp(() {
    requester = AppRequesterMock();
    datasource = GetEventDatasource(requester: requester);
  });

  String url = "www.google.com";

  test("Should call the GetEvent with correct Method", () async {
  ...
  test("Should return a Success Message when is successful", () async {
    ...
    Response response = await datasource.getEvent(url);
  ...
  test("Should throw a BadRequestException when the the request is invalid",
    ...
    final result = datasource.getEvent(url);
